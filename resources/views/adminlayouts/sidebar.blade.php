<div class="sidebar" id="sidebar">
    <ul class="sidebar-links">
        ...
        <li class="tab-list"><a href="#" class="link"><span class="img-icon"><img class="img"
                        src="{{ asset('stylecontainer/images/Fork Lift.png') }}" alt="icon"></span>Handling</a></li>
        <li class="tab-list"><a href="/corporate-information" class="link"><span class="img-icon"><img class="img"
                        src="{{ asset('stylecontainer/images/Folder.png') }}" alt="icon"></span>Corporate
                information</a></li>
    </ul>
